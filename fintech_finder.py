...
################################################################################
# Streamlit Code
#use streamlit to write markdown . I want to chain markdown to streamlit ( i want to markdown down "Fintech Finder!"). Inside the streamlit package is the 
# are the dimensions for placement of mardowns.(pading and margins)
## = smaller text
#st. is short streamlit
...
# we are chaining sidebar and markdown together calling streamlit. ---> inside 
...
#creatomg a select box and inside we are able to show all the different people .
person = st.sidebar.selectbox('Select a Person', people)

# Create a input field to record the number of hours the candidate worked
#what ever hours you put in ---> will be saved to stream
# able to put in external data internally 
hours = st.sidebar.number_input("Number of Hours")

st.sidebar.markdown("## Candidate Name, Hourly Rate, and Ethereum Address")

# Identify the FinTech Hire candidate
# we are taking the candidate data 85-92. We are taking line 158 and taking that person. Whatever persn we have picked in 
# we have taken the 0 index from dictionary
